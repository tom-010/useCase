		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getUseCaseAccess().getAlternatives_10(), "rule__UseCase__Alternatives_10");
					...
					put(grammarAccess.getOptionalInputsAccess().getAlternatives_0(), "rule__OptionalInputs__Alternatives_0");
					put(grammarAccess.getOptionalInputsAccess().getAlternatives_0_0(), "rule__OptionalInputs__Alternatives_0_0");
					put(grammarAccess.getOptionalInputsAccess().getAlternatives_0_1_0(), "rule__OptionalInputs__Alternatives_0_1_0");
					...
					put(grammarAccess.getRaiseErrorConditionalAccess().getAlternatives_0(), "rule__RaiseErrorConditional__Alternatives_0");
					put(grammarAccess.getRaiseErrorConditionalAccess().getAlternatives_1(), "rule__RaiseErrorConditional__Alternatives_1");
					put(grammarAccess.getRaiseErrorNowAccess().getAlternatives_0(), "rule__RaiseErrorNow__Alternatives_0");
					...
					put(grammarAccess.getUseCaseAccess().getGroup_10_0(), "rule__UseCase__Group_10_0__0");
					put(grammarAccess.getUseCaseAccess().getGroup_10_1(), "rule__UseCase__Group_10_1__0");
					...
					put(grammarAccess.getOptionalInputsAccess().getGroup(), "rule__OptionalInputs__Group__0");
					put(grammarAccess.getOptionalInputsAccess().getGroup_0_0_1(), "rule__OptionalInputs__Group_0_0_1__0");
					put(grammarAccess.getOptionalInputsAccess().getGroup_0_1(), "rule__OptionalInputs__Group_0_1__0");
					put(grammarAccess.getOptionalInputsAccess().getGroup_0_1_0_0(), "rule__OptionalInputs__Group_0_1_0_0__0");
					...
					put(grammarAccess.getRaiseErrorConditionalAccess().getGroup(), "rule__RaiseErrorConditional__Group__0");
					put(grammarAccess.getRaiseErrorConditionalAccess().getGroup_1_0(), "rule__RaiseErrorConditional__Group_1_0__0");
					put(grammarAccess.getRaiseErrorConditionalAccess().getGroup_1_1(), "rule__RaiseErrorConditional__Group_1_1__0");
					put(grammarAccess.getRaiseErrorNowAccess().getGroup(), "rule__RaiseErrorNow__Group__0");
					put(grammarAccess.getRaiseErrorNowAccess().getGroup_0_0(), "rule__RaiseErrorNow__Group_0_0__0");
					put(grammarAccess.getRaiseErrorNowAccess().getGroup_0_1(), "rule__RaiseErrorNow__Group_0_1__0");
					...
					put(grammarAccess.getUseCaseAccess().getOptionalInputsAssignment_5(), "rule__UseCase__OptionalInputsAssignment_5");
					put(grammarAccess.getUseCaseAccess().getOutputsAssignment_6(), "rule__UseCase__OutputsAssignment_6");
					put(grammarAccess.getUseCaseAccess().getPreconditionsAssignment_7(), "rule__UseCase__PreconditionsAssignment_7");
					put(grammarAccess.getUseCaseAccess().getStepsAssignment_8(), "rule__UseCase__StepsAssignment_8");
					put(grammarAccess.getUseCaseAccess().getNotesAssignment_9(), "rule__UseCase__NotesAssignment_9");
					...
					put(grammarAccess.getOptionalInputsAccess().getInputsAssignment_1(), "rule__OptionalInputs__InputsAssignment_1");
					...
					put(grammarAccess.getStepAccess().getExceptionAssignment_1_4(), "rule__Step__ExceptionAssignment_1_4");
					put(grammarAccess.getRaiseErrorConditionalAccess().getExceptionAssignment_2(), "rule__RaiseErrorConditional__ExceptionAssignment_2");
					put(grammarAccess.getRaiseErrorNowAccess().getExceptionAssignment_1(), "rule__RaiseErrorNow__ExceptionAssignment_1");
					...
					put(grammarAccess.getBooleanConditionAccess().getNameAssignment(), "rule__BooleanCondition__NameAssignment");
					...
					put(grammarAccess.getTypeAccess().getDescriptionAssignment_2_1(), "rule__Type__DescriptionAssignment_2_1");
					put(grammarAccess.getTypeAccess().getImportInfoAssignment_3_1(), "rule__Type__ImportInfoAssignment_3_1");
