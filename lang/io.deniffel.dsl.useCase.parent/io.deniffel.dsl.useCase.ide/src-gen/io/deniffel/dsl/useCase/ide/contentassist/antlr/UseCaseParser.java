		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRaiseErrorAccess().getAlternatives_1_0(), "rule__RaiseError__Alternatives_1_0");
					put(grammarAccess.getRaiseErrorAccess().getAlternatives_1_1(), "rule__RaiseError__Alternatives_1_1");
					...
					put(grammarAccess.getRaiseErrorAccess().getGroup_1_0_0(), "rule__RaiseError__Group_1_0_0__0");
					put(grammarAccess.getRaiseErrorAccess().getGroup_1_0_1(), "rule__RaiseError__Group_1_0_1__0");
					put(grammarAccess.getRaiseErrorAccess().getGroup_1_1_0(), "rule__RaiseError__Group_1_1_0__0");
					put(grammarAccess.getRaiseErrorAccess().getGroup_1_1_1(), "rule__RaiseError__Group_1_1_1__0");
